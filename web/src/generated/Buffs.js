...
$root.core = (function() {
    ...
    core.RPCDetails = (function() {

        /**
         * Properties of a RPCDetails.
         * @memberof core
         * @interface IRPCDetails
         * @property {number|null} [Tracker] RPCDetails Tracker
         * @property {boolean|null} [IsResponse] RPCDetails IsResponse
         */

        /**
         * Constructs a new RPCDetails.
         * @memberof core
         * @classdesc Represents a RPCDetails.
         * @implements IRPCDetails
         * @constructor
         * @param {core.IRPCDetails=} [properties] Properties to set
         */
        function RPCDetails(properties) {
            if (properties)
         ...
         * @memberof core.RPCDetails
         * @instance
         */
        RPCDetails.prototype.Tracker = 0;

        /**
         * RPCDetails IsResponse.
         * @member {boolean} IsResponse
         * @memberof core.RPCDetails
         * @instance
         */
        RPCDetails.prototype.IsResponse = false;

        /**
         * Creates a new RPCDetails instance using the specified properties.
         * @function create
         * @memberof core.RPCDetails
         * @static
         * @param {core.IRPCDetails=} [properties] Properties to set
         * @returns {core.RPCDetails} RPCDetails instance
         */
        RPCDetails.create = function create(properties) {
            return new RPCDetails(properties);
        };

        /**
         * Encodes the specified RPCDetails message. Does not implicitly {@link core.RPCDetails.verify|verify} messages.
         * @function encode
         * @memberof core.RPCDetails
         * @static
         * @param {core.IRPCDetails} message RPCDetails message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        RPCDetails.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.Tracker != null && Object.hasOwnProperty.call(message, "Tracker"))
                writer.uint32(/* id 1, wireType 5 =*/13).sfixed32(message.Tracker);
        ...
        /**
         * Encodes the specified RPCDetails message, length delimited. Does not implicitly {@link core.RPCDetails.verify|verify} messages.
         ...
         * @returns {$protobuf.Writer} Writer
         */
        RPCDetails.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };

        /**
         * Decodes a RPCDetails message from the specified reader or buffer.
         * @function decode
         * @memberof core.RPCDetails
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {core.RPCDetails} RPCDetails
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        RPCDetails.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.core.RPCDetails();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
                    message.Tracker = reader.sfixed32();
                    break;
                case 2:
        ...
        /**
         * Decodes a RPCDetails message from the specified reader or buffer, length delimited.
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        RPCDetails.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
         ...
         */
        RPCDetails.verify = function verify(message) {
        ...
        /**
         * Creates a RPCDetails message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof core.RPCDetails
         * @static
         ...
         * @returns {core.RPCDetails} RPCDetails
         */
        RPCDetails.fromObject = function fromObject(object) {
            if (object instanceof $root.core.RPCDetails)
                return object;
            var message = new $root.core.RPCDetails();
        ...
        /**
         * Creates a plain object from a RPCDetails message. Also converts values to other types if specified.
         * @function toObject
         * @memberof core.RPCDetails
         * @static
         * @param {core.RPCDetails} message RPCDetails
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        RPCDetails.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.defaults) {
        ...
        /**
         * Converts this RPCDetails to JSON.
         * @function toJSON
         * @memberof core.RPCDetails
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        RPCDetails.prototype.toJSON = function toJSON() {
    ...
    core.Headers = (function() {
         ...
         * @memberof core
         * @interface IHeaders
         * @property {number|null} [CmdID] Headers CmdID
         * @property {boolean|null} [HasData] Headers HasData
         * @property {core.IRPCDetails|null} [RPC] Headers RPC
         */
         ...
         * @implements IHeaders
         * @constructor
         * @param {core.IHeaders=} [properties] Properties to set
         */
         ...
         * Headers CmdID.
         * @member {number} CmdID
         * @memberof core.Headers
         * @instance
         */
        Headers.prototype.CmdID = 0;
         ...
         * @instance
         */
        Headers.prototype.HasData = false;

        /**
         * Headers RPC.
         * @member {core.IRPCDetails|null|undefined} RPC
         * @memberof core.Headers
         * @instance
         */
        Headers.prototype.RPC = null;
        ...
        /**
         * Headers _RPC.
         * @member {"RPC"|undefined} _RPC
         * @memberof core.Headers
         * @instance
         */
        Object.defineProperty(Headers.prototype, "_RPC", {
            get: $util.oneOfGetter($oneOfFields = ["RPC"]),
         ...
         * @static
         * @param {core.IHeaders=} [properties] Properties to set
         * @returns {core.Headers} Headers instance
         */
        ...
        /**
         * Encodes the specified Headers message. Does not implicitly {@link core.Headers.verify|verify} messages.
         * @function encode
         * @memberof core.Headers
         * @static
         * @param {core.IHeaders} message Headers message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        Headers.encode = function encode(message, writer) {
            ...
            if (message.CmdID != null && Object.hasOwnProperty.call(message, "CmdID"))
                writer.uint32(/* id 1, wireType 5 =*/13).sfixed32(message.CmdID);
            if (message.HasData != null && Object.hasOwnProperty.call(message, "HasData"))
                writer.uint32(/* id 2, wireType 0 =*/16).bool(message.HasData);
            if (message.RPC != null && Object.hasOwnProperty.call(message, "RPC"))
                $root.core.RPCDetails.encode(message.RPC, writer.uint32(/* id 3, wireType 2 =*/26).fork()).ldelim();
            return writer;
        };

        /**
         * Encodes the specified Headers message, length delimited. Does not implicitly {@link core.Headers.verify|verify} messages.
         * @function encodeDelimited
         * @memberof core.Headers
         * @static
         * @param {core.IHeaders} message Headers message or plain object to encode
        ...
        Headers.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.core.Headers();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
                    message.CmdID = reader.sfixed32();
                    break;
                case 2:
                    message.HasData = reader.bool();
                    break;
                case 3:
                    message.RPC = $root.core.RPCDetails.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
        ...
        Headers.verify = function verify(message) {
            ...
            if (message.RPC != null && message.hasOwnProperty("RPC")) {
                properties._RPC = 1;
                {
                    var error = $root.core.RPCDetails.verify(message.RPC);
                    if (error)
                        return "RPC." + error;
                }
            }
        ...
        Headers.fromObject = function fromObject(object) {
            if (object instanceof $root.core.Headers)
                return object;
            var message = new $root.core.Headers();
            ...
            if (object.RPC != null) {
                if (typeof object.RPC !== "object")
                    throw TypeError(".core.Headers.RPC: object expected");
                message.RPC = $root.core.RPCDetails.fromObject(object.RPC);
            }
            return message;
        };
         ...
         * @memberof core.Headers
         * @static
         * @param {core.Headers} message Headers
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        Headers.toObject = function toObject(message, options) {
            ...
            if (message.RPC != null && message.hasOwnProperty("RPC")) {
                object.RPC = $root.core.RPCDetails.toObject(message.RPC, options);
                if (options.oneofs)
                    object._RPC = "RPC";
            }
            return object;
...
$root.google = (function() {
    ...
    google.protobuf = (function() {
        ...
        protobuf.MethodOptions = (function() {
             ...
             * @member {number} .method.CmdID
             * @memberof google.protobuf.MethodOptions
             * @instance
             */
            MethodOptions.prototype[".method.CmdID"] = 0;
             ...
             * @instance
             */
            MethodOptions.prototype[".method.Sender"] = 0;
            ...
            MethodOptions.encode = function encode(message, writer) {
                ...
                if (message[".method.Sender"] != null && Object.hasOwnProperty.call(message, ".method.Sender"))
                    writer.uint32(/* id 50001, wireType 0 =*/400008).int32(message[".method.Sender"]);
                return writer;
            };
            ...
            MethodOptions.decode = function decode(reader, length) {
                ...
                while (reader.pos < end) {
                    ...
                    case 50000:
                        ...
                        break;
                    case 50001:
                        message[".method.Sender"] = reader.int32();
                        break;
                    default:
                        reader.skipType(tag & 7);
                        break;
            ...
            MethodOptions.verify = function verify(message) {
                ...
                if (message[".method.CmdID"] != null && message.hasOwnProperty(".method.CmdID"))
                    if (!$util.isInteger(message[".method.CmdID"]))
                        return ".method.CmdID: integer expected";
                if (message[".method.Sender"] != null && message.hasOwnProperty(".method.Sender"))
                    switch (message[".method.Sender"]) {
                    default:
                        return ".method.Sender: enum value expected";
                    case 0:
                    case 1:
                    case 2:
                        break;
            ...
            MethodOptions.fromObject = function fromObject(object) {
                ...
                if (object[".method.CmdID"] != null)
                    message[".method.CmdID"] = object[".method.CmdID"] | 0;
                switch (object[".method.Sender"]) {
                case "CLIENT":
                case 0:
                    message[".method.Sender"] = 0;
                    break;
                case "SERVER":
                case 1:
                    message[".method.Sender"] = 1;
                    break;
                case "BOTH":
                case 2:
                    message[".method.Sender"] = 2;
                    break;
                }
                return message;
            };
            ...
            MethodOptions.toObject = function toObject(message, options) {
                ...
                if (options.defaults) {
                    ...
                    object[".method.Sender"] = options.enums === String ? "CLIENT" : 0;
                }
                if (message.deprecated != null && message.hasOwnProperty("deprecated"))
                    object.deprecated = message.deprecated;
                if (message.uninterpretedOption && message.uninterpretedOption.length) {
